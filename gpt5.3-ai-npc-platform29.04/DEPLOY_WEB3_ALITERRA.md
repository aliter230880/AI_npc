...
Enable LLM responses (OpenAI chat):

`OPENAI_CHAT_MODEL=gpt-4o-mini`

Enable server STT transcription:
...
- `POST /v1/stt`
- `GET /v1/diagnostics`
- `POST /v1/diagnostics/tts`
- `GET /v1/characters`
- `GET /v1/characters/:characterId`
- `GET /v1/characters/:characterId/config`
- `PATCH /v1/characters/:characterId/config`
- `GET /v1/characters/:characterId/memories`
- `POST /v1/characters/:characterId/memories`
- `PATCH /v1/characters/:characterId/memories/:memoryId`
- `DELETE /v1/characters/:characterId/memories/:memoryId`
- `DELETE /v1/characters/:characterId/memories`
- `GET /v1/characters/:characterId/knowledge`
- `POST /v1/characters/:characterId/knowledge`
- `DELETE /v1/characters/:characterId/knowledge/:documentId`
