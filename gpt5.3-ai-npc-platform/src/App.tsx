...
export default function App() {
  ...
  async function handleVoiceInput() {
    if (!speechSupported || isBusy || isListening || recognitionRef.current || voiceDisabledReason) {
      return;
    }
      ...
      <section className="relative flex min-h-[85vh] items-end overflow-hidden">
        ...
        >
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Запускаем боевой MVP платформы AI-персонажей под web3.aliterra.space
          </h1>
                ...
                >
                  ...
                  <form className="mt-5 flex gap-3" onSubmit={handleSend}>
                    ...
                    <button
                      ...
                      disabled={!speechSupported || isBusy || isListening || Boolean(voiceDisabledReason)}
